...
SRCS	= $(addprefix $(SRCS_DIR)/, main.c input/check.c input/check_line.c input/check_key_value.c errors_free_and_exit.c parsing/parsing.c parsing/color_conversion.c \
